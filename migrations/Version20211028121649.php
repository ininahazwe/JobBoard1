 ...
 */
final class Version20211028121649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise ADD description LONGTEXT DEFAULT NULL, ADD site_web VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise DROP description, DROP site_web');
